...
import { makeStyles, createStyles, Theme, Typography, Button, List, ListItem, ListItemText, Collapse } from '@material-ui/core';
...
const UserGroupView = (props: PropTypes) => {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < data.length; i++) initToogleList.push(false);
