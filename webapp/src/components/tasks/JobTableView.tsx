  ...
  return (
    ...
    >
      <Box display="flex" alignItems="center">
        <Tooltip title={t("global:tasks.refresh") as string} sx={{ mr: 4 }}>
        ...
        <FormControl variant="outlined" sx={{ m: 1, mr: 3, minWidth: 160 }}>
          ...
          <Select
            ...
            label={t("global:tasks.typeFilter")}
          >
            {filterList.map((item) => (
      ...
      <TableContainer sx={scrollbarStyle} component={Paper}>
        <Table sx={{ width: "100%", height: "90%" }} aria-label="simple table">
          <TableHead>
            ...
            >
              <TableCell>{t("global:global.jobs")}</TableCell>
              <TableCell align="right">{t("global:study.type")}</TableCell>
              ...
              <TableCell align="right">{t("global:tasks.action")}</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {currentContent
