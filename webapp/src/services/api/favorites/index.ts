...
const BASE_URL = "/v1/favorites" as const;
const STUDIES_FAVORITES_URL = `${BASE_URL}/studies` as const;
const DIRECTORIES_FAVORITES_URL = `${BASE_URL}/directories` as const;
