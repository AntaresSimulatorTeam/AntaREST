...
export const variantColor = (variant: TreeVariant) =>
  variant === "managed" ? "info.main" : "text.secondary";
...
export const separatorSx = (variant: TreeVariant): SxProps<Theme> => ({
...
export const chipSx = (variant: TreeVariant, interactive: boolean) => (theme: Theme) => {
  const color =
