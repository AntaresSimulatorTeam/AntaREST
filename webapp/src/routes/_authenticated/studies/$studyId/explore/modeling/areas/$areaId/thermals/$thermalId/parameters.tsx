      ...
      {({ control, watch }) => {
        ...
        return (
          <>
            ...
            <Fieldset legend={t("study.modeling.clusters.operatingCosts")}>
              {semver.gte(study.version, "8.7.0") && (
                <>
                  <SelectFE
                    label={t("study.modeling.clusters.costGeneration")}
                    name="costGeneration"
                    options={COST_GENERATION_OPTIONS}
                    control={control}
                  />
                  <NumberFE
                    label={t("study.modeling.clusters.efficiency")}
                    name="efficiency"
                    control={control}
                    rules={{
                      validate: validateNumber({ min: 0 }),
                  ...
                  />
                  <NumberFE
                    label={t("study.modeling.clusters.variableOMCost")}
                    name="variableOMCost"
                    control={control}
                    rules={{
                      validate: validateNumber({ min: 0 }),
              ...
              <NumberFE
                label={t("study.modeling.clusters.marginalCost")}
                name="marginalCost"
                control={control}
                rules={{
                  validate: validateNumber({ min: 0 }),
              ...
              />
              <NumberFE
                label={t("study.modeling.clusters.startupCost")}
                name="startupCost"
                control={control}
                rules={{
                  validate: validateNumber({ min: 0 }),
              ...
              />
              <NumberFE
                label={t("study.modeling.clusters.marketBidCost")}
                name="marketBidCost"
                control={control}
                rules={{
                  validate: validateNumber({ min: 0 }),
              ...
              />
              <NumberFE
                label={t("study.modeling.clusters.fixedCost")}
                name="fixedCost"
                control={control}
                rules={{
                  validate: validateNumber({ min: 0 }),
              ...
              />
              <NumberFE
                label={t("study.modeling.clusters.spreadCost")}
                name="spreadCost"
                control={control}
              />
            </Fieldset>
            ...
            <Fieldset legend={t("study.modeling.clusters.timeSeriesGen")}>
              ...
              />
              <NumberFE
                label={t("study.modeling.clusters.volatilityForced")}
              ...
              />
              <NumberFE
                label={t("study.modeling.clusters.volatilityPlanned")}
              ...
              />
              <SelectFE
                label={t("study.modeling.clusters.lawForced")}
                name="lawForced"
                control={control}
                options={TS_LAW_OPTIONS}
              />
              <SelectFE
                label={t("study.modeling.clusters.lawPlanned")}
                name="lawPlanned"
                control={control}
                options={TS_LAW_OPTIONS}
              />
