...
function Fields() {
  ...
  const handleOccurrencesChange = (newOccurrences: StorageConstraintOccurrences) => {
    ...
    <>
      {displayAlert && (
        <Alert severity="warning" sx={{ mb: 1 }}>
          {t("study.modeling.storages.additionalConstraints.occurrences.alert")}
        </Alert>
      )}
      <Fieldset legend={t("study.modeling.storages.additionalConstraints.properties")}>
