  ...
  const matricesAllVersions = [
    {
      ...
      linkOptions: linkOptions({
        to: "/studies/$studyId/explore/modelization/areas/$areaId/storages/$storageId/time-series/modulation",
        params,
      }),
    },
    {
      ...
      linkOptions: linkOptions({
        to: "/studies/$studyId/explore/modelization/areas/$areaId/storages/$storageId/time-series/rule-curves",
        params,
      }),
    },
    {
      ...
      linkOptions: linkOptions({
        to: "/studies/$studyId/explore/modelization/areas/$areaId/storages/$storageId/time-series/inflows",
        params,
      }),
    },
  ];
  ...
  const matrices920 = [
    {
      ...
      linkOptions: linkOptions({
        to: "/studies/$studyId/explore/modelization/areas/$areaId/storages/$storageId/time-series/costs",
        params,
      }),
    },
    {
      ...
      linkOptions: linkOptions({
        to: "/studies/$studyId/explore/modelization/areas/$areaId/storages/$storageId/time-series/variation-costs",
        params,
      }),
    },
    {
      ...
      linkOptions: linkOptions({
        to: "/studies/$studyId/explore/modelization/areas/$areaId/storages/$storageId/time-series/level-cost",
        params,
      }),
    },
  ];
