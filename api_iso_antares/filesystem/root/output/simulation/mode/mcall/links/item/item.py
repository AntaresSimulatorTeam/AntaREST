...
from api_iso_antares.filesystem.root.output.simulation.mode.mcall.links.item.values import (
    OutputSimulationModeMcAllLinksItemValues as Values,
)
from api_iso_antares.filesystem.root.output.simulation.mode.mcall.links.item.id import (
