...
from api_iso_antares.domain.study.root.input.miscgen.miscgen import (
    InputMiscGen,
)
from api_iso_antares.domain.study.root.input.reserves.reserves import (
    InputReserves,
)
from api_iso_antares.domain.study.root.input.solar.solar import InputSolar
from api_iso_antares.domain.study.root.input.thermal.thermal import (
    InputThermal,
)
from api_iso_antares.domain.study.root.input.wind.wind import InputWind
