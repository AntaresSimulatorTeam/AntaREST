...
from api_iso_antares.domain.study.root.output.simulation.economy.mcind.scn.areas.item.details import (
    OutputSimulationEconomyMcIndScnAreasItemDetails as Details,
)

from api_iso_antares.domain.study.root.output.simulation.economy.mcind.scn.areas.item.values import (
