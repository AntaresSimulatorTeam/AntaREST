...
from api_iso_antares.domain.study.root.output.simulation.economy.mcall.areas.item.details import (
    OutputSimulationEconomyMcAllAreasItemDetails as Details,
)
from api_iso_antares.domain.study.root.output.simulation.economy.mcall.areas.item.id import (
    OutputSimulationEconomyMcAllAreasItemId as Id,
)
from api_iso_antares.domain.study.root.output.simulation.economy.mcall.areas.item.values import (
