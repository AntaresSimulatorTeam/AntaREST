...
def init_db_singleton(
    ...
    """
    Initialize singleton session maker that will be used throughout the app.
    This must be called before any actual use of the middleware, in particular,
    but also other services that might use the "db" helper.
    """
    global _Session
...
class DBSessionMiddleware(BaseHTTPMiddleware):
    def __init__(
        ...
        # TODO SL: check it's initialized
