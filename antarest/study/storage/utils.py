...
def is_study_folder(dir):
    return dir.is_dir() and (dir / "study.antares").exists()


def get_workspace_from_config(config: Config, workspace_name: str, default_allowed=False) -> WorkspaceConfig:
