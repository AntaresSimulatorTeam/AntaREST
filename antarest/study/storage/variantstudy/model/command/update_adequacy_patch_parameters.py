...
class UpdateAdequacyPatchParametersResult(CommandApplicationResult):
    data: AdequacyPatchParameters
...
class UpdateAdequacyPatchParameters(ICommand):
    ...
    def _apply_dao(self, study_data: StudyDao, listener: ICommandListener | None = None) -> CommandOutput:
        ...
        result = UpdateAdequacyPatchParametersResult(data=new_parameters)
