...
def validate_matrix(matrix: Union[List[List[MatrixData]], str], values: Any) -> str:
    matrix_id: str
    if isinstance(matrix, list):
        matrix_id = MATRIX_PROTOCOL_PREFIX + values["command_context"].matrix_service.create(data=matrix)
        ...
        raise ValueError(f"The data {matrix} is neither a matrix nor a link to a matrix")
