...
class ClusteredRenewableClusterSeries(FolderNode):
    ...
    def build(self) -> TREE:
        ...
        children: TREE = {
            series_id: ClusteredRenewableSeries(self.matrix_storage_context, self.config.next_file(series_id))
...
class ClusteredRenewableAreaSeries(FolderNode):
    ...
    def build(self) -> TREE:
        return {
            area: ClusteredRenewableClusterSeries(self.matrix_storage_context, self.config.next_file(area), area)
