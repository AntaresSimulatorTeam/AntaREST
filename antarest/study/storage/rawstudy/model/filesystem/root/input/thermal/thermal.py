...
class InputThermal(FolderNode):
    ...
    def build(self) -> TREE:
        children: TREE = {
            "clusters": InputThermalClusters(self.matrix_storage_context, self.config.next_file("clusters")),
            "prepro": InputThermalPrepro(self.matrix_storage_context, self.config.next_file("prepro")),
            "series": InputThermalSeries(self.matrix_storage_context, self.config.next_file("series")),
