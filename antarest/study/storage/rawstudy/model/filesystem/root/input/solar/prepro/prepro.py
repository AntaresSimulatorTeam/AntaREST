...
from antarest.storage.business.rawstudy.model.filesystem.root.input.solar.prepro.area.area import (
    InputSolarPreproArea,
)
from antarest.storage.business.rawstudy.model.filesystem.root.input.solar.prepro.correlation import (
