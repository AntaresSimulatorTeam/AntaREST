...
class LinkDTO(Area):
    ...
    colorr: int = Field(default=DEFAULT_COLOR, gt=0, lt=256)
    colorb: int = Field(default=DEFAULT_COLOR, gt=0, lt=256)
    colorg: int = Field(default=DEFAULT_COLOR, gt=0, lt=256)
    link_width: float = 1
