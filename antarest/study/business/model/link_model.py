...
class LinkDTO(Area):
    ...
    colorr: int = Field(default=DEFAULT_COLOR, ge=0, lt=256)
    colorb: int = Field(default=DEFAULT_COLOR, ge=0, lt=256)
    colorg: int = Field(default=DEFAULT_COLOR, ge=0, lt=256)
    link_width: float = 1
