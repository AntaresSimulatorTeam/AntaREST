...
class TableTemplateType(EnumIgnoreCase):
    ...
    Attributes:
        AREA: Area table.
        LINK: Link table.
        THERMAL_CLUSTER: Thermal clusters table.
        RENEWABLE_CLUSTER: Renewable clusters table.
...
class TableModeManager:
    ...
    def get_table_data(
        ...
        if table_type == TableTemplateType.AREA:
            ...
            data = {
                f"{area_id} / {storage_id}": storage.dict(by_alias=True)
                for area_id, thermals_by_ids in thermals_by_areas.items()
                for storage_id, storage in thermals_by_ids.items()
            }
            ...
            data = {
                ...
                for storage_id, storage in renewables_by_ids.items()
            }
            ...
            data = {
                ...
                for storage_id, storage in storages_by_ids.items()
            }
    ...
    def update_table_data(
        ...
        if table_type == TableTemplateType.AREA:
            ...
            data = {
                f"{area_id} / {cluster_id}": cluster.dict(by_alias=True)
    ...
    def get_table_schema(self, table_type: TableTemplateType) -> JSON:
        """
