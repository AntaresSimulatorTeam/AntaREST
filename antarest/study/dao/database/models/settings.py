...
GENERAL_CONFIG_TABLE = Table(
    ...
    ForeignKeyConstraint(
        ["study_id"], ["study_data_container.study_id"], name="fk_general_config_study_id", ondelete="CASCADE"
    ),
)
...
ADVANCED_PARAMETERS_TABLE = Table(
    ...
    ForeignKeyConstraint(
        ["study_id"], ["study_data_container.study_id"], name="fk_advanced_parameters_study_id", ondelete="CASCADE"
    ),
)
...
COMPATIBILITY_PARAMETERS_TABLE = Table(
    ...
    ForeignKeyConstraint(
        ["study_id"], ["study_data_container.study_id"], name="fk_compatibility_parameters_study_id", ondelete="CASCADE"
    ),
)
...
OPTIMIZATION_PREFERENCES_TABLE = Table(
    ...
    ForeignKeyConstraint(
        ["study_id"], ["study_data_container.study_id"], name="fk_optimization_preferences_study_id", ondelete="CASCADE"
    ),
)
...
TIMESERIES_CONFIG_TABLE = Table(
    ...
    ForeignKeyConstraint(
        ["study_id"], ["study_data_container.study_id"], name="fk_timeseries_config_study_id", ondelete="CASCADE"
    ),
)
...
PLAYLIST_TABLE = Table(
    ...
    ForeignKeyConstraint(
        ["study_id"], ["study_data_container.study_id"], name="fk_playlist_study_id", ondelete="CASCADE"
    ),
)
