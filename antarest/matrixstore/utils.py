...
def write_tsv_matrix_to_file(data: MatrixDTO, filepath: Path):
...
def write_tsv_matrix(data: MatrixDTO, output_tmp_dir: Path):
    name = Path(f"matrix-{data.id}.txt")
    filepath = output_tmp_dir / name
