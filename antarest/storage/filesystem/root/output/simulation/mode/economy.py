...
from antarest.storage.filesystem.root.output.simulation.mode.mcall.mcall import (
    OutputSimulationModeMcAll,
)
from antarest.storage.filesystem.root.output.simulation.mode.mcind.mcind import (
