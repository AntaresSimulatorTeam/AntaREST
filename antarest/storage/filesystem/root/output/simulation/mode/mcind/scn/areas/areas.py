...
from antarest.storage.filesystem.root.output.simulation.mode.mcind.scn.areas.item.area import (
    OutputSimulationModeMcIndScnAreasArea as Area,
)
from antarest.storage.filesystem.root.output.simulation.mode.mcind.scn.areas.item.set import (
