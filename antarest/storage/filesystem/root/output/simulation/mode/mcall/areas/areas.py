...
from antarest.storage.filesystem.root.output.simulation.mode.mcall.areas.item.area import (
    OutputSimulationModeMcAllAreasArea as Area,
)
from antarest.storage.filesystem.root.output.simulation.mode.mcall.areas.item.set import (
