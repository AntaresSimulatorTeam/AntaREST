...
from antarest.storage.filesystem.root.output.simulation.mode.mcall.links.item.values import (
    OutputSimulationModeMcAllLinksItemValues as Values,
)
from antarest.storage.filesystem.root.output.simulation.mode.mcall.links.item.id import (
