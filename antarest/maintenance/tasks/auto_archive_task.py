...
from antarest.maintenance.tasks.common import MaintenanceContextNotFoundError, TaskName


@celery_app.task(bind=True, name=TaskName.AUTO_ARCHIVER, pydantic=True)
