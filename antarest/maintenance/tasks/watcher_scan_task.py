...
from antarest.maintenance.tasks.common import MaintenanceContextNotFoundError, TaskName, WatcherScanTaskResult
from antarest.maintenance.tasks.watcher_scan import scan_workspaces


@celery_app.task(bind=True, name=TaskName.WATCHER_SCAN, pydantic=True)
