...
from tests.integration.utils import wait_for, wait_task_completion
...
def test_craft(client: TestClient, user_access_token: str, internal_study_id: str) -> None:
    ...
    assert res.json() == {
        ...
        "version": "8.8",
        "name": "STA-mini",
        "path": "/home/belthlemar/Projects/Antares/AntaREST/target/test_craft0/internal_workspace/c761e2c7-03df-4751-8c56-096d888d5699",
        "outputs": {
