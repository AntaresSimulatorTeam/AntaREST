...
class TestSTStorage:
    ...
    def test_lifecycle__nominal(
        ...
        res = client.post(
            f"/v1/studies/{study_id}/areas/{area_id}/st-storage/{siemens_battery_id}?new_cluster_name={new_name}",
            headers={"Authorization": f"Bearer {user_access_token}"},
        )
        ...
        fake_id = "fake_id"
        res = client.post(
            f"/v1/studies/{study_id}/areas/{area_id}/st-storage/{fake_id}?new_cluster_name=duplicata",
            headers={"Authorization": f"Bearer {user_access_token}"},
        )
