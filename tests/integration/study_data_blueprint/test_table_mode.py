...
class TestTableMode:
    ...
    def test_lifecycle__nominal(
        ...
        assert res.status_code == 200, res.json()
        expected = {
            "de / 01_solar": {"group": "Other 2", "nominalCapacity": 500000.0, "so2": 8.25, "unitCount": 17},
            "de / 02_wind_on": {"group": "Nuclear", "nominalCapacity": 314159.0, "so2": 0.0, "unitCount": 15},
