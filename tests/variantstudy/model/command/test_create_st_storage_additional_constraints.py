...
class TestCreateSTStorageAdditionalConstraint:
    ...
    def test_error_cases(self, command_context: CommandContext, empty_study_920: FileStudy):
        ...
        with pytest.raises(ValueError, match="Hours must be integers between 1 and 168, got 173"):
            STStorageAdditionalConstraintCreation(name="c1", occurrences=[Occurrence(hours=[173])])
