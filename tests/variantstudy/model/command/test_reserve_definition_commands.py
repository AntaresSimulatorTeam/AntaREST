...
class TestCreateReserveDefinition:
    def test_apply(self, dao_10_2: StudyDao, command_context: CommandContext) -> None:
        ...
        assert dao_10_2.reserve_definition_exists("paris", "reserve 1")

    def test_apply_duplicate_fails(self, dao_10_2: StudyDao, command_context: CommandContext) -> None:
        save_area(dao_10_2, "paris")
    ...
    def test_apply_creates_default_need_matrix(self, dao_10_2: StudyDao, command_context: CommandContext) -> None:
        save_area(dao_10_2, "paris")
        ...
        matrix = dao_10_2.get_reserve_need("paris", "r1")
...
class TestUpdateReserveDefinitions:
    def test_apply(self, dao_10_2: StudyDao, command_context: CommandContext) -> None:
        _seed_two_reserves(dao_10_2, command_context)
        ...
        assert dao_10_2.get_reserve_definition("paris", "r2").spillage_cost == 5.0

    def test_apply_not_found(self, dao_10_2: StudyDao, command_context: CommandContext) -> None:
        _seed_two_reserves(dao_10_2, command_context)
...
class TestRemoveReserveDefinitions:
    def test_apply(self, dao_10_2: StudyDao, command_context: CommandContext) -> None:
        ...
        output = command.apply(dao_10_2)
        assert output.status
        assert not dao_10_2.reserve_definition_exists("paris", "R1")

    def test_not_found(self, dao_10_2: StudyDao, command_context: CommandContext) -> None:
        save_area(dao_10_2, "paris")
    ...
    def test_apply_removes_need_matrix(self, dao_10_2: StudyDao, command_context: CommandContext) -> None:
        save_area(dao_10_2, "paris")
        CreateReserveDefinition(
            area_id="paris",
            parameters=ReserveDefinitionCreation(name="R1", type=ReserveType.UP),
        ...
        assert dao_10_2.get_all_reserve_needs().get("paris", {}).get(reserve_id) is not None
        ...
        assert reserve_id not in dao_10_2.get_all_reserve_needs().get("paris", {})
