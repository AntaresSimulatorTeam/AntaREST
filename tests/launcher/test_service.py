...
class TestLauncherService:
    ...
    def test_service_get_solver_versions(
        ...
        launcher_config = LauncherConfig(default=config["default"], cfg=launcher_configs)
        ...
        [
            pytest.param(
                ...
                marks=pytest.mark.xfail(
                    raises=InvalidConfigurationError,
                    strict=True,
                    reason="Configuration is not available for the 'default' launcher",
                ),
            ),
            pytest.param(
                {
    ...
    def test_get_nb_cores(
        ...
        launcher_config = LauncherConfig(default=config_map.get("default"), cfg=launchers)
