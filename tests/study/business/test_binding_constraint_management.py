...
class TestConstraintFilter:
    ...
    def test_filter_by__bc_id(self, bc_id: str, expected: bool) -> None:
        ...
        constraint = BindingConstraint(**{"id": "bc1", "name": "BC1"})
    ...
    def test_filter_by__enabled(self, enabled: t.Optional[bool], expected: bool) -> None:
        """
    ...
    def test_filter_by__operator(self, operator: BindingConstraintOperator | None, expected: bool) -> None:
        """
        ...
        constraint = BindingConstraint(**{"id": "bc1", "name": "BC1", "operator": BindingConstraintOperator.EQUAL})
        assert bc_filter.match_filters(constraint) == expected

    @pytest.mark.parametrize("comments, expected", [("hello", True), ("HELLO", True), ("goodbye", False), ("", True)])
    def test_filter_by__comments(self, comments: str, expected: bool) -> None:
        """
        ...
        constraint = BindingConstraint(**{"id": "bc1", "name": "BC1", "comments": "Say hello!"})
        assert bc_filter.match_filters(constraint) == expected
    ...
    def test_filter_by__group_with_existing_group(self, group: str, expected: bool) -> None:
        ...
        """
        bc_filter = ConstraintFilters(group=group)
        constraint = BindingConstraint(**{"id": "bc1", "name": "BC1", "group": "Grp1"})
        assert bc_filter.match_filters(constraint) == expected

    @pytest.mark.parametrize("time_step, expected", [("hourly", True), ("daily", False), (None, True)])
    def test_filter_by__time_step(self, time_step: BindingConstraintFrequency | None, expected: bool) -> None:
        """
        ...
        constraint = BindingConstraint(**{"id": "bc1", "name": "BC1", "time_step": BindingConstraintFrequency.HOURLY})
        assert bc_filter.match_filters(constraint) == expected
    ...
    def test_filter_by__area_name(self, area_name: str, expected: bool) -> None:
        """
    ...
    def test_filter_by__cluster_name(self, cluster_name: str, expected: bool) -> None:
        """
    ...
    def test_filter_by__link_id(self, link_id: str, expected: bool) -> None:
        """
        The filter should match if one of the constraint's terms has a cluster name which contains
        the filter's cluster name or if the filter is empty.
        Comparisons should be case-insensitive.
    ...
    def test_filter_by__cluster_id(self, cluster_id: str, expected: bool) -> None:
        """
        The filter should match if one of the constraint's terms has a cluster name which contains
        the filter's cluster name or if the filter is empty.
        Comparisons should be case-insensitive.
