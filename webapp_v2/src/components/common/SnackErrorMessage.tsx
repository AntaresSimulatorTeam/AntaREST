...
import { Box, Card, CardActions, Collapse, Grid, IconButton, Paper, styled, Typography } from '@mui/material';
...
export const ExpandButton = styled(IconButton, { shouldForwardProp: (prop) => prop !== 'expanded' })<{expanded?: boolean}>(({ theme, expanded }) => ({
  padding: '8px 8px',
      ...
      <Card sx={{
        ...
        </CardActions>
        {
          ...
          <Collapse in={expanded} timeout="auto" unmountOnExit>
            <Paper sx={{ p: 2 }}>
              <Grid container spacing={1} sx={{ width: '100%', height: '100%', mt: 1 }}>
                <Grid item xs={6}>
                  <Label>Status :</Label>
