...
export const NavListItem = styled(ListItem, { shouldForwardProp: (prop) => prop !== 'link' })<{link?: boolean, extended?: boolean}>(({ theme, link }) => ({
  cursor: 'pointer',
  width: '100%',
  height: '60px',
  padding: 0,
...
export const NavDrawer = styled(Drawer, options)<{extended?: boolean}>(({ extended }) => ({
